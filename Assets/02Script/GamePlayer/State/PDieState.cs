...
{
    public class PDieState : PState
    {
        public PDieState(string animation, PStateMachine machine, Player player) : base(animation, machine, player)
        {
        }
        ...
        public override void Enter(int x, int y)
        {
            ...
            Player.Animator.SetBool(AnimBool[4],true);
        }
