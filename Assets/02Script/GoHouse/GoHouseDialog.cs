...
namespace _02Script.GoHouse
{
    public class GoHouseDialog : DialogEntity
    {
        ...
        private void GetBossItem(DialogEntitySO entity, int c, int f)
        {
            ...
            int.TryParse(GameManager.Instance.PlayerStat.characterLastText[entity.EntityName][DialogType.Chapter],out chapter);
            if (chapter <= 0) chapter = baseChapter;
            int.TryParse(GameManager.Instance.PlayerStat.characterLastText[entity.EntityName][DialogType.Num],out finalNum);
